      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-3xl font-bold text-gray-800">{stats.totalSpotteds}</p>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Médias por Spotted</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 bg-gray-50 rounded-xl">
              <p className="text-2xl font-bold text-pink-500">{stats.avgLikes}</p>
              <p className="text-xs text-gray-500">Curtidas</p>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-xl">
              <p className="text-2xl font-bold text-blue-500">{stats.avgComments}</p>
              <p className="text-xs text-gray-500">Comentários</p>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-xl">
              <p className="text-2xl font-bold text-orange-500">{stats.todaySpotteds}</p>
              <p className="text-xs text-gray-500">Posts Hoje</p>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-xl">
              <p className="text-2xl font-bold text-purple-500">{stats.peakHour}h</p>
        ...
        {/* Gráfico semanal */}
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Últimos 7 Dias</h2>
        ...
        {/* Spotteds recentes */}
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Spotteds Recentes</h2>
          <div className="space-y-3">
            {stats.recentSpotteds.map((spotted) => (
              <div key={spotted.id} className="flex items-start gap-3 p-3 bg-gray-50 rounded-xl">
                <span className="px-2 py-1 bg-pink-100 text-pink-600 rounded-full text-xs font-bold">
                  #{spotted.number}
                </span>
                <p className="flex-1 text-sm text-gray-700 line-clamp-2">{spotted.message}</p>
